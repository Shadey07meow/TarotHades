    ...
    public void startGamePanel()
    {
        ...
        TreasureChest tr1 = new TreasureChest(
            Vector2.add(
                ...
                Vector2.multiply(
                    Vector2.UP, 
                    -24 * 120* GameFrame.getScreenMultiplier())),  
            player, 2, this);
        ...
        world.addObject(new BarrierObject(
            Vector2.add(
                this.center,
                new Vector2(-11 * 64* GameFrame.getScreenMultiplier(), 13 * 64* GameFrame.getScreenMultiplier())),
                this,
        ...
        world.addObject(new BarrierObject(
            Vector2.add(
                this.center,
                new Vector2(-15 * 64* GameFrame.getScreenMultiplier(), -4 * 64* GameFrame.getScreenMultiplier())),
                this,
                new Bounds(3 * 64, 3 * 64, 3 * 64, 3 * 64
            )));
        ...
        world.addObject(new BarrierObject(
            Vector2.add(
                this.center,
                new Vector2(-13 * 64* GameFrame.getScreenMultiplier(), -8 * 64* GameFrame.getScreenMultiplier())),
                this,
                new Bounds(3 * 64, 3 * 64, 3 * 64, 3 * 64
            )));
        ...
        world.addObject(new BarrierObject(
            Vector2.add(
                this.center,
                new Vector2(-14 * 64* GameFrame.getScreenMultiplier(), -20 * 64* GameFrame.getScreenMultiplier())),
                this,
                new Bounds(3 * 64, 3 * 64, 3 * 64, 3 * 64
            )));
        ...
        world.addObject(new BarrierObject(
            Vector2.add(
                this.center,
                new Vector2(-14 * 64* GameFrame.getScreenMultiplier(), -25 * 64* GameFrame.getScreenMultiplier())),
                this,
                new Bounds(3 * 64, 3 * 64, 3 * 64, 3 * 64
            )));
        ...
        world.addObject(new BarrierObject(
            Vector2.add(
                this.center,
                new Vector2(-14 * 64* GameFrame.getScreenMultiplier(), -28 * 64* GameFrame.getScreenMultiplier())),
                this,
                new Bounds(3 * 64, 3 * 64, 3 * 64, 3 * 64
            )));
        ...
        world.addObject(new BarrierObject(
            Vector2.add(
                this.center,
                new Vector2(15 * 64* GameFrame.getScreenMultiplier(), -40 * 64* GameFrame.getScreenMultiplier())),
                this,
                new Bounds(3 * 64, 3 * 64, 3 * 64, 3 * 64
            )));
        ...
        world.addObject(new BarrierObject(
            Vector2.add(
                this.center,
                new Vector2(0, -56 * 120 * GameFrame.getScreenMultiplier())
            ), 
            this, 
            new Bounds(3 * 64, 3 * 64, 3 * 64, 3 * 64
        )));
        ...
        world.addObject(new FinalBoss(Vector2.add(
                this.center,
                new Vector2(0, -30 * 64 * GameFrame.getScreenMultiplier())),
            4,
            this
        ));
